...
This project is born as a course for teaching Ruby on Rails to the La Rioja (spain) Ruby group.
...
Create and setup a database for development and another one for testing
  ...
  mysqladmin create time_tracker -uroot
  mysqladmin create time_tracker_test -uroot
  rake db:migrate
